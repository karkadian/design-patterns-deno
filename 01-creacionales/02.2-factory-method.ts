...
class FinancesReport implements Report {
  generate(): void {
...
class FinancesReportFactory extends ReportFactory {
  createReport(): Report {
...
function main() {
  ...
  const reportType = prompt(
    '¿Qué tipo de reporte deseas? (sales/inventory/finances): '
  );
  ...
  switch (reportType) {
    ...
    case 'inventory':
      ...
      break;
    case 'finances':
      reportFactory = new FinancesReportFactory();
      break;
    default:
